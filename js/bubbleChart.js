...
function bubbleChart(width, height) {
  ...
  var tooltip = floatingTooltip('bfaf_tooltip', 240);
...
function drawBubbleChart(data, width, height, svgSelector){
  // Load the data.
  // d3.csv('data/gates_money.csv', display);
  chart = bubbleChart(width, height);
  chart(svgSelector, data);
}
if(typeof window.bfaf === 'undefined'){ window.bfaf = {}}
window.bfaf.drawBubbleChart = drawBubbleChart
